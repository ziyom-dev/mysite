...
from wagtail.models import Orderable, ClusterableModel, DraftStateMixin, RevisionMixin
from modelcluster.models import ParentalKey
from autoslug import AutoSlugField
from django.db import transaction
from Customer.models import User
from .widgets import UserChooserWidget, AttributeValueChooserWidget, AttributeChooserWidget
...
class Product(DraftStateMixin, RevisionMixin, ClusterableModel):
    ...
    # Attributes
    attributes_panels = [
        InlinePanel('product_attrs', label='Атрибуты'),
    ]
        ...
        FieldRowPanel(
            [
                ...
                FieldPanel('attribute_value', widget=AttributeValueChooserWidget(linked_fields={
                    'attribute': {'match': r'^id_product_attrs-\d+-', 'append': 'attribute'}
                }))
            ]
        )
    ]
