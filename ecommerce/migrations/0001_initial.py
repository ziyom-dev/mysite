# Generated by Django 5.0.1 on 2024-03-07 11:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability', models.CharField(choices=[('0', 'Нет в наличии'), ('1', 'Есть в наличии'), ('2', 'Скоро')], default='2', max_length=20)),
                ('description', wagtail.fields.RichTextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_images', to='ecommerce.product')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
